...
public class FPS_DistortionAndBloom : MonoBehaviour
{
	...
	public Material mat
	{
		get
		{
			if (m_Material == null)
			{
				m_Material = CheckShaderAndCreateMaterial(Shader.Find("Hidden/KriptoFX/PostEffects/FPS_Bloom"));
			}
			return m_Material;
		}
	}
	...
	public Material matAdditive
	{
		get
		{
			...
			{
				m_MaterialAdditive = CheckShaderAndCreateMaterial(Shader.Find("Hidden/KriptoFX/PostEffects/FPS_BloomAdditive"));
